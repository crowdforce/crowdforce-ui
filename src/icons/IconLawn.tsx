function IconLawn({
    ...
    return (
        <svg width={size} height={size} viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg" {...props}>
            ...
            <path fill="none" stroke={color} strokeWidth={stroke} strokeLinecap="round" strokeLinejoin="round" d="M 16.999701 15.9998 C 16.204 15.9998 15.441 16.315901 14.878401 16.8785 C 14.315701 17.441099 13.999701 18.204201 13.999701 18.9998 M 16.999701 13.3332 C 16.204 13.3332 15.441 13.6492 14.878401 14.211901 C 14.315701 14.7745 13.999701 15.5375 13.999701 16.3332 M 16.999701 10.6665 C 16.204 10.6665 15.441 10.982599 14.878401 11.5452 C 14.315701 12.1078 13.999701 12.870899 13.999701 13.6665 M 11.333 15.9998 C 12.806299 15.9998 13.999701 17.343201 13.999701 18.9998 M 11.333 13.3332 C 12.806299 13.3332 13.999701 14.6765 13.999701 16.3332 M 11.333 10.6665 C 12.806299 10.6665 13.999701 12.0098 13.999701 13.6665 M 13.999701 8.6665 L 13.999701 12.6665" />
        </svg>
    )
}
